  ...
  const loginUser = async (e) => {
    ...
    signIn("credentials", { ...data, redirect: true, callbackUrl: "/" }).then((callback) => {
      ...
      if (callback?.ok && !callback?.error) {
        ...
        setData({ email: "", password: "", nickname: "", userClass: "" });
        SetEmail("");
        if (callback?.url) {
      ...
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-10">
          ...
          >
            ...
            {/* <form>
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-10 lg:justify-between lg:gap-10">
                <input
                  type="email"
                  placeholder="이메일 주소"
                  name="email"
                  ...
                  className="w-full border-b border-stroke !bg-white pb-1 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:!bg-black dark:focus:border-manatee dark:focus:placeholder:text-white "
                />
                ...
                >
                  <span className="mr-3">
                    ...
                    >
                      <g clipPath="url(#clip0_95:967)">
                        <path
                          d="M13.56 10.61 6.15 0 0 0 0 19.83 6.44 19.83 6.44 9.22 13.85 19.83 20 19.83 20 0 13.56 0 13.56 10.61z"
                          fill="#03c75a"
                        />
                      </g>
                      <defs>
